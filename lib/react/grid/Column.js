...
Jii.defineClass('Jii.view.react.grid.Column', /** @lends Jii.view.react.grid.Column.prototype */{
     ...
     */
    renderDataCell: function (model, key, index) {
     ...
     */
    _renderHeaderCellContent: function () {
        return Jii._s.trim(this.header) !== '' ? this.header : this.grid.emptyCell;
    },
     ...
     * @returns {string} the rendering result
     */
    _renderFooterCellContent: function () {
        return Jii._s.trim(this.footer) !== '' ? this.footer : this.grid.emptyCell;
    },
     ...
     * @returns {string} the rendering result
     */
    _renderDataCellContent: function (model, key, index) {
