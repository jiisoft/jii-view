 ...
 */
Jii.defineClass('Jii.view.react.grid.DataColumn', /** @lends Jii.view.react.grid.DataColumn.prototype */{

    __extends: 'Jii.view.react.grid.Column',
    ...
    _renderHeaderCellContent: function () {
        ...
        if (label === null) {
            var provider = this.grid.collection;
            ...
            if (label === null) {
                var model = this.grid.state.models[0];
                if (model instanceof Jii.base.Model) {
                    label = model.getAttributeLabel(this.attribute);
                } else {
                    label = Jii._s.humanize(this.attribute);
                }
            }
        }
     ...
     */
    getDataCellValue: function (model, key, index) {
        if (this.value !== null) {
            if (Jii._.isFunction(this.value)) {
    ...
    _renderDataCellContent: function (model, key, index) {
        if (this.content === null) {
            // @todo return this.grid.formatter.format(this.getDataCellValue(model, key, index), this.format);
