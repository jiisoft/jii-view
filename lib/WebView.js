 ...
 */
Jii.defineClass('Jii.view.WebView', /** @lends Jii.view.WebView.prototype */{
    ...
    registerMetaTag: function (options, key) {
        ...
        if (!Jii._.has(this.metaTags, key)) {
    ...
    registerLinkTag: function (options, key) {
        ...
        if (!Jii._.has(this.linkTags, key)) {
            options[this.__static.DATA_KEY_NAME] = key;
    ...
    registerCssFile: function (url, options, key) {
        ...
        if (!Jii._.has(this.cssFiles, key)) {
            options.href = url;
    ...
    registerJs: function (js, position, key) {
        ...
        if (!Jii._.has(this.js[position], key)) {
            var options = {
    ...
    registerJsFile: function (url, options, key) {
        ...
        if (!Jii._.has(this.jsFiles[position], key)) {
            options[this.__static.DATA_KEY_NAME] = key;
    ...
    // @todo
    renderFile: function(view, params) {
