...
Jii.defineClass('Jii.view.WebView', {
	...
	/**
	 * @type {Object<String, Jii.view.AssetBundle|Boolean>} list of the registered asset bundles. The keys are the bundle names, and the values
	 * are the registered [[Jii.view.AssetBundle]] objects.
	 ...
	 * @returns {Jii.view.AssetManager} the asset manager. Defaults to the "assetManager" application component.
	 */
	 ...
	 * @param {Jii.view.AssetManager} value the asset manager
	 */
	...
	registerCssFile: function (url, options, key) {
		...
		if (!depends) {
			...
			this.getAssetManager().bundles[key] = new Jii.view.AssetBundle({
				baseUrl: '',
