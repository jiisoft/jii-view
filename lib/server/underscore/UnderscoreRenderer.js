 ...
 */
Jii.defineClass('Jii.view.underscore.UnderscoreRenderer', /** @lends Jii.view.underscore.UnderscoreRenderer.prototype */{
     ...
     * @returns {*}
     */
    renderFile: function (viewFile, context, params, controller, webView) {
        params = params || {};
    ...
    renderJsFile: function (file, params, webView) {
        params = params || {};
    ...
    getTemplate: function(path) {
        ...
        this._templates[path] = Jii._.template(require('fs').readFileSync(path).toString());
